...
public class FrmConsultaAlumno extends JInternalFrame implements ActionListener {
	...
	public FrmConsultaAlumno() {
		...
		JLabel lblNewLabel = new JLabel("Consulta alumno por nombre y apellido");
		...
		lblNewLabel_1.setIcon(new ImageIcon(FrmConsultaAlumno.class.getResource("/iconos/Boy.gif")));
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblNewLabel_1.setBounds(10, 68, 99, 25);
		getContentPane().add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("Apellidos:");
		lblNewLabel_2.setIcon(new ImageIcon(FrmConsultaAlumno.class.getResource("/iconos/Boy.gif")));
		lblNewLabel_2.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblNewLabel_2.setBounds(323, 70, 93, 23);
		getContentPane().add(lblNewLabel_2);
		
		txtNombres = new JTextField();
		txtNombres.setFont(new Font("Tahoma", Font.PLAIN, 13));
		txtNombres.setBounds(119, 67, 165, 20);
		getContentPane().add(txtNombres);
		txtNombres.setColumns(10);
		
		txtApellidos = new JTextField();
		txtApellidos.setFont(new Font("Tahoma", Font.PLAIN, 13));
		txtApellidos.setBounds(426, 67, 165, 20);
		getContentPane().add(txtApellidos);
		txtApellidos.setColumns(10);
		
		BtnBuscar = new JButton("Buscar");
		BtnBuscar.setIcon(new ImageIcon(FrmConsultaAlumno.class.getResource("/iconos/Search.gif")));
		BtnBuscar.setFont(new Font("Tahoma", Font.PLAIN, 13));
		BtnBuscar.addActionListener(this);
		BtnBuscar.setBounds(832, 60, 145, 33);
