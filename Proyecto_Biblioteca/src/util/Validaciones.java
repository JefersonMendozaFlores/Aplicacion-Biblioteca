...
public class Validaciones {
	public static final String TEXTO = "[a-zA-Z·ÈÌÛ˙Ò¸¡…Õ”⁄—‹\\s]{2,30}";
	...
	public static final String PISO ="[0-9]{1}";
	public static final String ALUMNOS = "[0-9]{2}";
	public static final String ESTADO ="[0-9]{1}";
	public static final String SERIELIBRO = "[0-6]{5}";
